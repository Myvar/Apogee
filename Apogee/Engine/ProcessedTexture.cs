...
namespace Apogee.Engine
{
    public class ProcessedTexture
    {
        ...
        public TextureView SurfaceTextureView;
            ...
            byte[] textureData)
        {
            ...
            SurfaceTexture = CreateDeviceTexture(GameEngine.GraphicsDevice,
                GameEngine.GraphicsDevice.ResourceFactory, TextureUsage.Sampled);
            SurfaceTextureView = GameEngine.GraphicsDevice.ResourceFactory.CreateTextureView(SurfaceTexture);
        }
